...
WPanel *panel_new_sized_empty (const char *panel_name, int y, int x, int lines, int cols);
WPanel *panel_new_sized_with_dir (const char *panel_name, int y, int x, int lines, int cols,
...
panel_new_empty (const char *panel_name)
{
    /* Unknown sizes of the panel at startup */
    return panel_new_sized_empty (panel_name, 0, 0, 1, 1);
}
...
{
    /* Unknown sizes of the panel at startup */
    return panel_new_sized_with_dir (panel_name, 0, 0, 1, 1, vpath);
}
...
static inline WPanel *
panel_new_sized (const char *panel_name, int y, int x, int lines, int cols)
{
    return panel_new_sized_with_dir (panel_name, y, x, lines, cols, NULL);
}
